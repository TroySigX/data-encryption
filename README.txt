THIS IS A SYMMETRIC CRYPTOGRAPHY PROGRAM USED TO ENCRYPT AND DECRYPT DATA 

EXAMPLE: For given plain text "text data to be processed", using the secret key "TroyCode", the output cipher is:
...
------END TPT ENCRYPTED DATA------"
 ...
 THIS CIPHER CAN BE FURTHER DECRYPTED TO THE ORIGINAL PLAIN TEXT USING THE SAME SECRET KEY
